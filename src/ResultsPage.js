      ...
      <PageLayoutV2>
         <PageHeader>
            <div className="text-gray-600">
               from <span className="text-gray-900">{startingPoint}</span>{" "}
               <br />
   ...
   return (
      <Fragment>
         ...
         {results.map(result => {
            ...
            let typicalDurationEpoch =
               result.json.routes[0].legs[0].duration.value;
            ...
            arrivalTime.setUTCSeconds(
               departureTimeEpoch + durationInTrafficEpoch
            );
